    ...
    return Column(
      children: [
        ...
        ZSButton(
          ...
          size: Size(120, 44),
          title: 'SHOW',
          onTap: () => {ZSToast.show(message: '您收到一个新的消息!')},
        ),
        // 代码
        ZSContainer(
    ...
    return Column(
      children: [
        ...
        ZSButton(
          ...
          size: Size(120, 44),
          title: 'SHOW',
          onTap: () => {ZSToast.showSuccess(message: '您收到一个新的消息!')},
        ),
        // 代码
        ZSContainer(
          width: double.infinity,
    ...
    return Column(
      children: [
        ...
        ZSButton(
          ...
          size: Size(120, 44),
          title: 'SHOW',
          onTap: () => {ZSToast.showError(message: '您收到一个新的消息!')},
        ),
        // 代码
        ZSContainer(
          width: double.infinity,
    ...
    return Column(
      children: [
        ...
        ZSButton(
          ...
          size: Size(120, 44),
          title: 'SHOW',
          onTap: () => {ZSToast.showWarming(message: '您收到一个新的消息!')},
        ),
        // 代码
        ZSContainer(
          width: double.infinity,
