...
class ZSCircularProgress extends StatefulWidget {
  ...
  @override
  _ZSCircularProgressState createState() => _ZSCircularProgressState();
}

class _ZSCircularProgressState extends State<ZSCircularProgress> with SingleTickerProviderStateMixin, AutomaticKeepAliveClientMixin {
  ...
  void _checkIfNeedCancelAnimation(ZSCircularProgress oldWidget) {
  ...
  @override
  void didUpdateWidget(ZSCircularProgress oldWidget) {
