...
class ZSLinearProgress extends StatefulWidget {
  /// 百分比 0-1之间
  ...
  @override
  _ZSLinearProgressState createState() => _ZSLinearProgressState();
}

class _ZSLinearProgressState extends State<ZSLinearProgress> with SingleTickerProviderStateMixin, AutomaticKeepAliveClientMixin {
  ...
  void _checkIfNeedCancelAnimation(ZSLinearProgress oldWidget) {
  ...
  @override
  void didUpdateWidget(ZSLinearProgress oldWidget) {
